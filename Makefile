...
SLUGLIB = -L./slug2 -lslug -lboost_system-mt -lboost_filesystem-mt -lboost_regex-mt -lcfitsio
MPICHLIB = #
OPT     += #
CXXFLAGS = $(CFLAGS)
endif
...
SLUGINCL = -I./slug2/src 
SLUGLIB = -L./slug2 -lslug -L/cineca/prod/opt/libraries/boost/1.61.0/intelmpi--2017--binary/lib -lboost_system -lboost_filesystem -lboost_regex
MPICHLIB = #
