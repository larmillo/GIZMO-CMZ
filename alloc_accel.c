...
void allocate_acc()
{
    ...
    All.potential_tot = malloc(Nx*Ny*Nz*sizeof(double));
	...
	for(int i=0; i < Nx*Ny*Nz; i++) All.potential_tot[i]*=1e10/(All.UnitVelocity_in_cm_per_s * All.UnitVelocity_in_cm_per_s);
